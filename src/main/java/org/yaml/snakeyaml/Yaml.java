...
public class Yaml
{
	...
	{
		Serializer serializer = new Serializer(new Emitter(output, dumperOptions), resolver, dumperOptions, null);
		try
		{
			serializer.open();
			serializer.serialize(node);
	...
	{
		Composer composer = new Composer(new ParserImpl(new StreamReader(yaml), loadingConfig), resolver, loadingConfig);
		constructor.setComposer(composer);
	...
	{
		final Composer composer = new Composer(new ParserImpl(new StreamReader(yaml), loadingConfig), resolver, loadingConfig);
