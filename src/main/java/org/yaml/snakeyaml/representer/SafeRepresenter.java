...
class SafeRepresenter extends BaseRepresenter
{
	...
	protected class RepresentIterator implements Represent
	{
		...
		public Node representData(Object data)
		{
			...
			return representSequence(getTag(data.getClass(), Tag.SEQ), new IteratorWrapper(iter), DumperOptions.FlowStyle.AUTO);
		}
	}
	...
	protected class RepresentMap implements Represent
	{
		...
		public Node representData(Object data)
		{
			return representMapping(getTag(data.getClass(), Tag.MAP), (Map<Object, Object>) data, DumperOptions.FlowStyle.AUTO);
		}
	}
